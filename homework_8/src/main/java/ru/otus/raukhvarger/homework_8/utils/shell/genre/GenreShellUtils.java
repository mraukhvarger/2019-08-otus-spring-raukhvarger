package ru.otus.raukhvarger.homework_8.utils.shell.genre;

import org.springframework.beans.factory.annotation.Qualifier;
import org.springframework.stereotype.Service;
import org.springframework.util.StringUtils;
import ru.otus.raukhvarger.homework_8.dto.GenreDTO;
import ru.otus.raukhvarger.homework_8.service.genre.GenreProvider;
    ...
    public void create() {
        ...
        while (!entered) {
            ...
            if (StringUtils.isEmpty(genreName)) {
                ...
                entered = true;
                GenreDTO genre = GenreDTO.builder().genreName(genreName).build();
